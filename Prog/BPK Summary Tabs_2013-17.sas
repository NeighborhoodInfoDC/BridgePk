/**************************************************************************
 Program:  BPK Summary Tabs_2013-17.sas
 Library:  BridgePk
...
** Define time periods  **;
%let _years = 2013_17;
%let year_lbl = 2013-17;

%macro Compile_bpk_data (geo, geosuf);

data compile_bpk_tabs_2013_17_&geosuf;
	merge 
		ACS.acs_2013_17_dc_sum_tr_&geosuf
			(keep= &geo
				totpop_&_years.
		...
		Acs.Acs_2013_17_dc_sum_bg_&geosuf
			(keep= &geo 
...
proc transpose data=compile_bpk_tabs_2013_17_&geosuf out=bpk_tabs_2013_17_&geosuf(label="Bridge Park Tabulations, &geo");
	var 	&geo 	
		...
		/*Residential property: total units, total sales, and median sales price: 2000 - 2018-Q3*/
		...
		/*Violent and property crime rates: 2000 - 2017*/
...
%File_info( data=compile_bpk_tabs_2013_17_&geosuf, contents=n, printobs=0 )

proc export data=bpk_tabs_2013_17_&geosuf
	outfile="&_dcdata_default_path\BridgePk\Data\bpktabs_2013_17_&geosuf..csv"
	dbms=csv replace;
	run;
